...
namespace TrilBDev\WikiPress\Includes\Elementor\Widgets\Wiki;

use Elementor\Controls_Manager;
use TrilBDev\WikiPress\Includes\Elementor\Templates\Template;
use TrilBDev\WikiPress\Includes\Elementor\Widgets\Widgets;
use WP_Query;
...
class WikiRelated extends Widgets {
    ...
    private function prepare_render_context( array $settings ): array {
        ...
        while ( $query->have_posts() ) {
            ...
            $views = (int) \get_post_meta( get_the_ID(), '_trilbdev_docs_views', true );
