...
Donate link: https://trilb.dev/donate/
Tags: tag1, tag2
...
WikiPress is a modular wiki platform for WordPress by TrilB.Dev. 
Featuring custom wiki post types, grouped settings, REST API endpoints, shared helpers, 
Bootstrap‑powered admin UI, Font Awesome support, and an extension system for internal and external plugins.
